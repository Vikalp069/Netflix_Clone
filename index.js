...
const apikey="fa7609a61f33d3c275979987f1d83524";
...
function buildMoviesSection(list, categoryName){
    ...
    const moviesListHTML = list.map(item => {
        ...
        <div class="movie-item" onmouseenter="searchMovieTrailer('${item.title}', 'yt${item.id}')">
            <img class="move-item-img" src="${imgPath}${item.backdrop_path}" alt="${item.title}" onclick="searchMovieTraile('$(item,title)')"/>
